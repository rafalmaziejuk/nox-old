...
struct Viewport {
    ...
    constexpr Viewport(float width, float height) : width{width},
                                                    height{height} {}

    constexpr Viewport(float x, float y, float width, float height, float nearClip = 0.0f, float farClip = 1.0f) : x{x},
                                                                                                                   y{y},
                                                                                                                   width{width},
                                                                                                                   height{height},
                                                                                                                   nearClip{nearClip},
