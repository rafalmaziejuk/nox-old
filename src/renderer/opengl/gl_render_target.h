...
class GLRenderTarget final : public GLRenderTargetBase {
    using ColorAttachmentsContainer = RenderTargetAttachmentsContainer::ColorAttachmentsContainer;
    using DepthStencilAttachmentsContainer = RenderTargetAttachmentsContainer::DepthStencilAttachmentsContainer;
  ...
  private:
    std::vector<GLTexture> m_depthStencilAttachments{};
    std::vector<uint32_t> m_attachmentPoints{};
    Vector2D<uint32_t> m_resolution{};
};
