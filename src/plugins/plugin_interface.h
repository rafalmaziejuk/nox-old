...
#define NOX_PLUGIN_LOAD(pluginName)                                                                         \
    ...
    namespace NOX::pluginName##Plugin {                                                                     \
        const bool pluginRegistered = PluginManager::instance().registerPlugin(createPlugin##pluginName()); \
    }
#endif
...
#define NOX_PLUGIN_LOAD(pluginName)                                                                                                                    \
    namespace NOX::pluginName##Plugin {                                                                                                                \
        const bool pluginRegistered = PluginManager::instance().registerPlugin(DynamicPlugin::create(#pluginName, createPluginFilenameWithExtension)); \
    }
#endif
